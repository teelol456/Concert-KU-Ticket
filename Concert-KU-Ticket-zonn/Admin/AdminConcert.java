...
public class AdminConcert extends JFrame implements ActionListener{
    ...
    private void setComponent() {
        ...
        ChooseImgBtn = new JButton(" + ");
        ChooseImgBtn.setBounds(700, 530, 150, 30); // ล่าง Delete 40 พิกเซล
        ChooseImgBtn.setBackground(Color.decode("#FF9999"));
