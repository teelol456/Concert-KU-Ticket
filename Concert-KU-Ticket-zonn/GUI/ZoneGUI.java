...
public class ZoneGUI extends JFrame implements ActionListener{
    ...
    private void Initial() {
        ...
        cp.setBackground(Color.decode("#F3F2EC")); // กำหนดสีพื้นหลัง
    }
    private void setComponent() {
        ...
        stage.setBackground(Color.decode("#253054"));
        ...
        protected void paintComponent(Graphics g) {
            ...
            // สีพื้นหลังของ label
            g2.setColor(Color.decode("#F4E99A"));  
        ...
        Seeleam.setForeground(Color.BLACK); // สีตัวอักษร
        ...
        cp.add(b3);        
        cp.add(Speaker, BorderLayout.WEST);  cp.add(Seeleam); 
